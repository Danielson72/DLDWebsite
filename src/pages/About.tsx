      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="flex justify-center mb-16">
          <div className="relative">
            <Mic size={64} className="text-amber-500 filter drop-shadow-[0_0_10px_rgba(245,158,11,0.5)]" />
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          {/* Who I Am Block */}
          <div className="relative p-8 rounded-lg border-2 border-green-500/50 shadow-[0_0_15px_rgba(0,255,0,0.2)] hover:scale-105 transition-all duration-300 bg-black/60 backdrop-blur-sm">
            <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#00ff00_1px,transparent_1px)] [background-size:16px_16px]"></div>
            <h2 className="text-3xl font-bold text-amber-500 mb-6">Who I Am</h2>
            ...
            <div className="absolute -right-6 top-1/2 w-12 h-1 bg-gradient-to-r from-green-500 to-transparent md:block hidden"></div>
          </div>

          {/* Kingdom Identity Block */}
          <div className="relative p-8 rounded-lg border-2 border-green-500/50 shadow-[0_0_15px_rgba(0,255,0,0.2)] hover:scale-105 transition-all duration-300 bg-black/60 backdrop-blur-sm">
            <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#00ff00_1px,transparent_1px)] [background-size:16px_16px]"></div>
            <h2 className="text-3xl font-bold text-amber-500 mb-6">Kingdom Identity</h2>
            <p className="text-gray-300 leading-relaxed">
            ...
            <div className="absolute left-1/2 -bottom-6 w-1 h-12 bg-gradient-to-b from-green-500 to-transparent"></div>
          </div>

          {/* Music & Message Block */}
          <div className="relative p-8 rounded-lg border-2 border-green-500/50 shadow-[0_0_15px_rgba(0,255,0,0.2)] hover:scale-105 transition-all duration-300 bg-black/60 backdrop-blur-sm md:col-span-2 md:w-2/3 mx-auto">
            <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#00ff00_1px,transparent_1px)] [background-size:16px_16px]"></div>
            <h2 className="text-3xl font-bold text-amber-500 mb-6">Music & Message</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <div className="relative p-8 rounded-lg border-2 border-green-500/50 shadow-[0_0_15px_rgba(0,255,0,0.2)] hover:scale-105 transition-all duration-300 bg-black/60 backdrop-blur-sm md:col-span-2 md:w-2/3 mx-auto">
            <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#00ff00_1px,transparent_1px)] [background-size:16px_16px]"></div>
            <h2 className="text-3xl font-bold text-amber-500 mb-6">Entrepreneurship</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          {/* Transformer Block */}
          <div className="relative p-8 rounded-lg border-2 border-gradient-gold-silver shadow-[0_0_15px_rgba(255,215,0,0.2)] hover:scale-105 transition-all duration-300 bg-black/60 backdrop-blur-sm md:col-span-2 md:w-2/3 mx-auto">
            <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#00ff00_1px,transparent_1px)] [background-size:16px_16px]"></div>
            <div className="absolute inset-0 bg-gradient-to-r from-amber-500/5 to-gray-300/5"></div>
            <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-gray-300 mb-6">Transformer (WIP)</h2>
            <p className="text-gray-300 leading-relaxed">
