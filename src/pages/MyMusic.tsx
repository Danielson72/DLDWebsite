        ...
        <div className="relative">
          ...
          {!user ? (
            <div className="text-center py-12">
              <div className="bg-black/60 backdrop-blur-sm border border-green-500/30 rounded-xl p-8 max-w-md mx-auto">
                <User size={64} className="text-amber-500 mx-auto mb-4" />
            ...
            <>
              ...
              <div className="bg-black/60 backdrop-blur-sm border border-green-500/30 rounded-lg p-6 mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-amber-500">Welcome back!</h2>
